function  TPxCalibrationTestingMGR(isTPX, screenNumber)
baseName='test';
% TPxCalibrationTestingMM(isTPX,screenNumber, baseName) %uncomment this line during actual testing 
...
%fileID3 = fopen(titlename, 'a');
    ...
    if (finish_calibration == 1)
        ...
        cal_status = TPxValidateCalibrationMGR(xy, isTPX, windowPtr, baseName, 0);
        if cal_status
            break;
        end
        finish_calibration = 0;
