function TPxTrackpixx3CalibrationTestingMM(screenNumber)
% TPxTrackpixx3CalibrationTestingMM(baseName, screenNumber)%uncomment for
% actual testing 
...
% screenNumber = 1; %0; %3 originally

TPxCalibrationTestingMM(1,screenNumber)

%TPxCalibrationTestingMM(1,screenNumber, baseName)%uncomment for actual
%testing 
end