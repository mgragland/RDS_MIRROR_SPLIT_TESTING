...
function [fixating, framecount, fixation_complete, xeye, yeye, eyedist]=IsFixatingSquareNew_MGR(SetUp_Info,xeye,yeye,fixating,framecount,design, eyedist)
...
%% Frame Flip Time 
neededfixcount=round(total_fixation_time/IFI); 

if fixating>neededfixcount
